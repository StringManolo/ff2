import { ff, activateShortcuts, routerController } from "./ff2.mjs";
...
const routes = {
    a: {
        ...
        action: () => {
            ...
            ff.render(ff.createElement(Landing, { innerText: "This is my landing page!", links: links }), target);
        }
    },
    b: {
        path: "App",
        action: () => {
            ff.render(ff.createElement(App, { innerText: "Hello!" }), target);
        }
    },
    c: {
        path: "default",
