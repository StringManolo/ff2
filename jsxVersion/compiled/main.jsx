import { ff, activateShortcuts, defineShortcut, routerController, cacheStart } from "./ff2.mjs";
...
const routes = {
  a: {
	...
	{ href: url + "#default", innerText: "Defualt Page" }
      ...
      ff.render(<Landing innerText="This is my landing page!" links={links} />, target);
    }
  },
  ...
  b:{
    path: "App",
    action: () => {
      ff.render(<App innerText="Hello!" />, target);
    }
  },
